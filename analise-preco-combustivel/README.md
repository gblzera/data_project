...
analise-vendas-combustivel/ │ ├── data/ │ └── vendas-combustivel.csv # Dados brutos da ANP │ ├── app.py # Aplicação Streamlit principal ├── requirements.txt # Dependências do projeto └── README.md # Este arquivo lindo aqui 💅
